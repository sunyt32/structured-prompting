...
class BloomAttention(nn.Module):
    ...
    def forward(
        ...
        matmul_result = alibi.baddbmm(
            batch1=query_layer.transpose(1, 2).reshape(-1, query_layer.shape[1], query_layer.shape[3]),
            batch2=key_layer.permute(0, 2, 3, 1).reshape(-1, key_layer.shape[3], key_layer.shape[1]),
            beta=self.beta,
...
class BloomModel(BloomPreTrainedModel):
    ...
    def forward(
        ...
        prefix_parallel: Optional[bool] = None,
        ...
        **deprecated_arguments
        ...
        if prefix_parallel is not None and prefix_parallel > 1:
            ...
            alibi = torch.cat((alibi, alibi[:, :, -current_sequence_length:].repeat(1, 1, prefix_parallel - 1)), dim=-1)
